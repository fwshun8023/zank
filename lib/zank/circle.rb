module Zank
  class Circle
    ...
    attr_accessor :id, :descript, :name, :take_count, :comment_role, :created_at, :notice, :post_role, :update_at, :comment_count, :cover_url
    ...
    def initialize(opts)
      ...
      self.update_at     = Time.at(opts[:updateTime].to_i / 1000) if opts[:commentCount]
